...
export default function TosPage() {
  return (
    <React.Fragment>
      ...
      <p>Welcome to Dashboard RML!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Dashboard RML's Website, located at dashboard-rml.mudi-dev.tech.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Dashboard RML if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Dashboard RML, you agreed to
        use cookies in agreement with the Dashboard RML's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Dashboard RML and/or its licensors own the
        intellectual property rights for all material on Dashboard RML. All
        intellectual property rights are reserved. You may access this from
        Dashboard RML for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Dashboard RML</li>
        <li>Sell, rent or sub-license material from Dashboard RML</li>
        <li>Reproduce, duplicate or copy material from Dashboard RML</li>
        <li>Redistribute content from Dashboard RML</li>
      </ul>
      ...
      <p>
        ...
        Dashboard RML does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Dashboard RML,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Dashboard RML shall not be
      ...
      <p>
        Dashboard RML reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Dashboard RML a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Dashboard RML; and (d) the link
      ...
      <p>
        ...
        e-mail to Dashboard RML. Please include your name, your organization
      ...
      <p>
        No use of Dashboard RML's logo or other artwork will be allowed for
